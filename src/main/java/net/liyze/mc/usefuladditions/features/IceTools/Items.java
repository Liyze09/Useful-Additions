package net.liyze.mc.usefuladditions.features.IceTools;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.liyze.mc.uapi.ub.builders.*;
import net.liyze.mc.usefuladditions.UsefulAdditions;
import net.liyze.mc.usefuladditions.features.CopperTools.CopperToolMaterial;
