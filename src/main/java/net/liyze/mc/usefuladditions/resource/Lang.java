...
import static net.liyze.mc.usefuladditions.features.CopperTools.Items.*;
import static net.liyze.mc.usefuladditions.features.IceTools.Items.*;
import static net.liyze.mc.usefuladditions.features.Quartzite.Items.QUARTZITE_SCRAP;
import static net.liyze.mc.usefuladditions.features.UniqueEnchantments.EnchantmentInstance.*;
...
abstract class Lang {
    ...
    static void generateLang() {
        ...
        if (cfg.enableCopperArmors)
            enUS
                    .add(net.liyze.mc.usefuladditions.features.CopperArmors.Items.COPPER_HELMET, "Copper Helmet")
                    .add(net.liyze.mc.usefuladditions.features.CopperArmors.Items.COPPER_CHESTPLATE, "Copper Chestplate")
                    .add(net.liyze.mc.usefuladditions.features.CopperArmors.Items.COPPER_LEGGINGS, "Copper Leggings")
                    .add(net.liyze.mc.usefuladditions.features.CopperArmors.Items.COPPER_BOOTS, "Copper Boots");
