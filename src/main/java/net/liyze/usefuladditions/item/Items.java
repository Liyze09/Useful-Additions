...
public class Items {
    ...
    public static final ToolItem COPPER_SWORD = new SwordItem(CopperToolMaterial.INSTANCE, 3, -2.5F, new FabricItemSettings().group(ITEM_GROUP));
    ...
    public static final ToolItem COPPER_HOE = new CustomHoeItem(CopperToolMaterial.INSTANCE, 1, -3.0F, new FabricItemSettings().group(ITEM_GROUP));
    public static final ToolItem COPPER_SHOVEL = new ShovelItem(CopperToolMaterial.INSTANCE, -3, -1.5F, new Item.Settings().group(ITEM_GROUP));
    /*Copper Armors*/
