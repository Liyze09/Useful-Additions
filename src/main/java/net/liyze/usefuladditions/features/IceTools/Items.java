...
public class Items {
    ...
    public static final ToolItem ICE_SHOVEL = new UShovelBuilder(CopperToolMaterial.INSTANCE, 9, -3, new FabricItemSettings().group(ITEM_GROUP), new Identifier(ID, "ice_shovel"), cfg.enableIceTools);
    public static final ToolItem ICE_HOE = new UHoeBuilder(CopperToolMaterial.INSTANCE, 2, -0.5F, new FabricItemSettings().group(ITEM_GROUP), new Identifier(ID, "ice_hoe"), cfg.enableIceTools);
}
